...
<div class="mdui-container mdui-m-y-4">
    <div class="mdui-row-xs-3 mdui-grid-list">
        ...
        <div class="mdui-col">
            <div class="mdui-grid-tile mdui-m-a-2">
            <a href="./English/"><img src="<?PHP echo img() ?>sources/img/card.webp"/></a>
            <div class="mdui-grid-tile-actions">
                <div class="mdui-grid-tile-text">
        ...
        <div class="mdui-col">
            <div class="mdui-grid-tile mdui-m-a-2">
            <a href="./Physics/"><img src="<?PHP echo img() ?>sources/img/wuli.png"/></a>
            <div class="mdui-grid-tile-actions">
                <div class="mdui-grid-tile-text">
        ...
        <div class="mdui-col">
            <div class="mdui-grid-tile mdui-m-a-2">
            <a href="./Chemistry/"><img src="<?PHP echo img() ?>sources/img/huaxue.png"/></a>
            <div class="mdui-grid-tile-actions">
                <div class="mdui-grid-tile-text">
